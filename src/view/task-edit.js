...
const createTaskEditDateTemplate = (dueDate) => `<button class="card__date-deadline-toggle" type="button">
...
const createTaskEditRepeatingTemplate = (repeating) => `<button class="card__repeat-toggle" type="button">
